...
git clone https://github.com/like-it/Priya /Vendor/Priya

mkdir -p /run/Vendor

cp -R /Vendor/Priya /run/Vendor

#priya

# save os

git clone https://github.com/like-it/Priya.Os.git /Vendor/Priya.Os	# only once
